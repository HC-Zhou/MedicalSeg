...
from lib.datasets.ISIC import ISIC2016, PH2
...
def parse_args():
    ...
    parser.add_argument('--ISIC_root', default=r'D:\迅雷下载\ISIC2016', type=str,
                        help='dataset path')
    parser.add_argument('--PH_root', default=r'D:\迅雷下载\PH2Dataset\PH2 Dataset images', type=str,
                        help='dataset path')
...
def main():
    ...
    if not args.resume:
        ...
        while os.path.exists(
                args.log_path + args.model + "_ISIC2016PH2_ver_" + str(count)):
            count += 1
        args.log_path = args.log_path + args.model + "_ISIC2016PH2_ver_" + str(count)
    ...
    # prepare data
    train_dataset = ISIC2016(root=args.ISIC_root,
                             mean=[0.724, 0.619, 0.567], std=[0.165, 0.172, 0.193],
                             img_size=args.img_size)
    ...
    val_dataset = PH2(root=args.PH_root,
                      mean=[0.724, 0.619, 0.567], std=[0.165, 0.172, 0.193],
                      img_size=args.img_size)
